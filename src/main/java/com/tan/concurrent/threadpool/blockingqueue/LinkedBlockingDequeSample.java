...
public class LinkedBlockingDequeSample {
    private LinkedBlockingDeque<Integer> linkedBlockingQueue = new LinkedBlockingDeque<Integer>(10);
    
    public static void main(String[] args) throws InterruptedException {
        final LinkedBlockingDequeSample arrayBlockingQueueTest = new LinkedBlockingDequeSample();
