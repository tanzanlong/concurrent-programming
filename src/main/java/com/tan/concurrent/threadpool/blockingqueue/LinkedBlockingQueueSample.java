...
public class LinkedBlockingQueueSample {
    private LinkedBlockingQueue<Integer> linkedBlockingQueue = new LinkedBlockingQueue<Integer>(10);
    
    public static void main(String[] args) throws InterruptedException {
        final LinkedBlockingQueueSample arrayBlockingQueueTest = new LinkedBlockingQueueSample();
