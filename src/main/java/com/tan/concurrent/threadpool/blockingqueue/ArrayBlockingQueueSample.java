...
public class ArrayBlockingQueueSample {
    private ArrayBlockingQueue<Integer> arrayBlockingQueue = new ArrayBlockingQueue<Integer>(10);
    
    public static void main(String[] args) throws InterruptedException {
        final ArrayBlockingQueueSample arrayBlockingQueueTest = new ArrayBlockingQueueSample();
