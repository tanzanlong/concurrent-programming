...
public class SynchronousQueueSample {
    private SynchronousQueue<Integer> linkedBlockingQueue = new SynchronousQueue<Integer>();
    
    public static void main(String[] args) throws InterruptedException {
        final SynchronousQueueSample arrayBlockingQueueTest = new SynchronousQueueSample();
